...
"""This file is responsible for scanning the "global truth" STO google sheet (Test Cells, Docks,
Conveyors, Safety Systems) and building the live zone lookup tables the GUI relies on.
...
def scan_zone_data(auth):
    ...
    Raises on any failure (network, auth, permissions, missing sheet); the caller is responsible for
    falling back to the hardcoded glossary values.
    """
