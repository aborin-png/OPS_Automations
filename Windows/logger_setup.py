...
def log_calls(func):
    '''
    Decorator that logs entry into `func` and any exception it raises. Arguments are
    deliberately NOT logged, to avoid leaking sensitive values (e.g. robot passwords).
    '''
